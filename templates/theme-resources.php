    ...
    <style type="text/tailwindcss">
        @layer base {
            ...
            :root[data-theme='light'] {
                color-scheme: light;
                --ui-body-bg: radial-gradient(circle at top, rgba(203, 213, 225, 0.75), rgba(248, 250, 252, 0.98) 55%);
                --ui-body-text: #0f172a;
                --ui-selection-bg: #2563eb;
                --ui-selection-text: #ffffff;
                --ui-surface-card-bg: rgba(255, 255, 255, 0.98);
                --ui-surface-card-border: rgba(100, 116, 139, 0.35);
                --ui-surface-card-shadow: 0 30px 60px -35px rgba(15, 23, 42, 0.25), 0 10px 24px -18px rgba(15, 23, 42, 0.18);
                --ui-surface-panel-bg: rgba(255, 255, 255, 0.96);
                --ui-surface-panel-border: rgba(148, 163, 184, 0.55);
                --ui-surface-muted: #4b5563;
                --ui-surface-heading: #0f172a;
                --ui-surface-subheading: #334155;
                --ui-surface-pill-bg: rgba(226, 232, 240, 0.9);
                --ui-surface-pill-text: #1f2937;
                --ui-field-bg: rgba(255, 255, 255, 0.98);
                --ui-field-text: #0f172a;
                --ui-field-border: rgba(100, 116, 139, 0.45);
                --ui-field-placeholder: rgba(71, 85, 105, 0.7);
                --ui-field-focus: #1d4ed8;
                --ui-table-head-bg: rgba(226, 232, 240, 0.95);
                --ui-table-head-text: #334155;
                --ui-table-row-border: rgba(203, 213, 225, 0.8);
                --ui-border-soft: rgba(226, 232, 240, 0.95);
                --ui-border-strong: rgba(100, 116, 139, 0.55);
                --ui-tag-bg-positive: rgba(16, 185, 129, 0.18);
                --ui-tag-border-positive: rgba(16, 185, 129, 0.4);
                --ui-tag-text-positive: #047857;
                --ui-tag-bg-negative: rgba(248, 113, 113, 0.18);
                --ui-tag-border-negative: rgba(248, 113, 113, 0.4);
                --ui-tag-text-negative: #b91c1c;
                --ui-divider-color: rgba(148, 163, 184, 0.45);
                --ui-topbar-bg: rgba(255, 255, 255, 0.95);
                --ui-topbar-border: rgba(148, 163, 184, 0.6);
                --ui-topbar-text: #1e293b;
                --ui-sidebar-bg: rgba(248, 250, 252, 0.98);
                --ui-sidebar-border: rgba(148, 163, 184, 0.6);
                --ui-sidebar-text: #111827;
                --ui-sidebar-active-bg: rgba(37, 99, 235, 0.18);
                --ui-sidebar-active-text: #111827;
                --ui-button-muted-bg: rgba(226, 232, 240, 0.95);
                --ui-button-muted-text: #0f172a;
            }
